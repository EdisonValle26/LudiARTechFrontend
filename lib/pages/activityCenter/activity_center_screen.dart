...
import 'widgets/activity_center_form.dart';
import 'widgets/activity_center_header.dart';
      ...
      body: SafeArea(
        child: Stack(
          children: [
            ...
            Column(
              children: [
                ActivityCenterHeader(scale: scale),
                Expanded(child: ActivityCenterForm(scale: scale)),
              ],
            ),
